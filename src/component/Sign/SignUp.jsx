...
export default function SignUp() {
    ...
    const handleSubmit = async (event) => {
        try {
            ...
            const Image = data.get("fileImage")
            const base64 = await convertToBase64(Image);
            console.log(base64);

            dispatch(register({ name, email, password, userImage: base64 }))
        }
        catch (error) {
            console.log(error)
        }
            ...
            <Container component="main" maxWidth="xs">
                ...
                >
                    ...
                    <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                        ...
                        {errorMsg && <Typography component="h1" fontSize={"20px"} color={"red"} align='center'>
                            {errorMsg}
                        </Typography>}
